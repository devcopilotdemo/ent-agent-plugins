...
2. **Build to the spec.** If `ent-designer` produced a spec, implement it exactly, including empty, loading, and error states. If no spec exists and the change is user-visible, request one.
